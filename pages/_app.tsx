    ...
    const storeReferrer = async () => {
      if (query.ref && mangoGroup) {
        ...
        if (query.ref.length === 44) {
          ...
          console.log("info____________111", info, referrerPda)
          if (info) {
...
const PageTitle = () => {
  ...
  return (
    <Head>
      <title>{marketTitleString}Phezzan Protocol Markets</title>
    </Head>
  )
}
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Phezzan Protocol" />
        ...
        <meta
          name="description"
          content="Democratize Perpetual Trading For All Earn yield while you trade."
        />
        <link
