...
const OrderbookRow = React.memo<any>(
  ({
    ...
    return (
      <div
        className={`relative flex cursor-pointer justify-between text-xs leading-none`}
        ref={element}
      >
        {invert ? (
          <>
            ...
            <div className="flex w-full items-center justify-between hover:font-semibold">
              <div
                ...
                className={`z-10 text-xs leading-5 md:pl-5 md:leading-5 ${
                  side === 'buy'
                    ? `text-th-green`
          ...
          <>
            <div className="flex w-full items-center justify-between hover:font-semibold">
              <div
                className={`z-10 text-xs leading-5 md:leading-5 ${
                  hasOpenOrder ? 'text-th-primary' : 'text-th-fgd-2'
                }`}
                onClick={handleSizeClick}
              >
              ...
              <div
                className={`z-10 text-xs leading-5 md:pr-4 md:leading-5 ${
                  side === 'buy'
                    ? `text-th-green`
                    : `text-th-red brightness-125`
                }`}
