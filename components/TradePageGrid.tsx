...
export const defaultLayouts = {
  ...
  //{"lg":[{"w":6,"h":30,"x":3,"y":0,"i":"tvChart","minW":2,"moved":false,"static":false},
  //{"w":3,"h":34,"x":0,"y":0,"i":"orderbook","minW":2,"moved":false,"static":false},
  //{"w":3,"h":52,"x":9,"y":0,"i":"tradeForm","minW":2,"moved":false,"static":false},
  //{"w":3,"h":18,"x":0,"y":34,"i":"marketTrades","minW":2,"moved":false,"static":false},
  //{"w":6,"h":22,"x":3,"y":30,"i":"userInfo","minW":6,"moved":false,"static":false}]}

  lg: [
    { i: 'marketTrades', x: 0, y: 34, w: 3, h: 18, minW: 2 },
    { i: 'orderbook', x: 0, y: 0, w: 3, h: 34, minW: 2 },
    { i: 'tvChart', x: 3, y: 0, w: 6, h: 30, minW: 2 },
    { i: 'tradeForm', x: 9, y: 0, w: 3, h: 52, minW: 2 },
    { i: 'userInfo', x: 3, y: 30, w: 6, h: 22, minW: 6 },
  ],
  // md: [
...
const TradePageGrid: React.FC = () => {
  ...
  const onLayoutChange = (layouts) => {
    console.log("layouts____", layouts)
    if (layouts) {
  ...
  return !isMobile ? (
    <>
      ...
      >
        <div key="tvChart">
          <FloatingElement className="h-full pl-0 p-0 md:p-0">
            <div className="flex items-center justify-between bg-[#1F2025] h-8 pl-7 md:pr-1 md:pb-1 md:pt-2.5">
              <ElementTitlePP noMarginBottom>Price Chart</ElementTitlePP>
            </div>
            <div className="h-[calc(100%_-_2rem)] md:pl-0 md:pr-1 md:pb-1 md:pt-2.5">
              <TVChartContainer />
            </div>
          </FloatingElement>
        </div>
        ...
        <div key="marketTrades">
          <FloatingElement className="h-full p-0 md:p-0">
            <RecentMarketTrades />
          </FloatingElement>
        </div>
        <div key="userInfo">
