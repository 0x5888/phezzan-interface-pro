    ...
    <Popover>
      {({ open }) => (
        <div className="relative flex flex-col">
          <Popover.Button
            className={`default-transition p-0.5 transition-none focus:outline-none`}
            ref={buttonRef}
          >
            <div className="flex items-center justify-between w-80 pl-2">
              ...
              <div className="pr-0.5 text-base text-white">{baseSymbol}</div>
