    ...
    <div className="bg-[#1F2025]">
      ...
      <div className="grid grid-cols-12 gap-x-1.5 gap-y-0.5 text-left mt-4">
        ...
        <div className="col-span-12 mt-4">
          {!isTriggerOrder ? (
            <>
              <label className="text-xxs text-th-fgd-3 mb-2">{t('price')}</label>
              <Input
        ...
        {isTriggerLimit && (
          <>
            <div className="col-span-12">
              <label className="text-xxs text-th-fgd-3 mb-2">
                {t('limit-price')}
              </label>
              <Input
                type="number"
          ...
          <nav className="-mb-px flex space-x-2 mt-2" aria-label="Tabs">
            <button
              ...
              className={`default-transition relative flex w-1/2 cursor-pointer
                border border-[#34353A] bg-[#1F2025] space-x-2 h-8
                items-center justify-center whitespace-nowrap py-1 text-xs md:text-sm md:hover:opacity-100
                ${
                  option === 'base'
                    ? `text-[#FFFFFF]`
                    : `text-[#8D8E99]`
              ...
              `}
            >
              {groupConfig.quoteSymbol.toUpperCase()}
            </button>
            <button
              ...
              `}
            >
              {marketConfig.baseSymbol.toUpperCase()}
            </button>
          </nav>
        </div>
        {option === "base" && (<div className="col-span-12 mt-1">
          {/* baseSymbol */}
          <Input
            type="number"
            min="0"
            ...
            value={baseSize}
          />
          <div className="text-xs text-right text-[#8D8E99] mt-3.5">
            ≈ {quoteSize || "--"}{`${groupConfig.quoteSymbol.toLowerCase()}`}
          </div>
        </div>)}
        {option === "quote" && <div className="col-span-12">
          <label className="text-xxs text-th-fgd-3 mb-2">{t('quantity')}</label>
          {/* quoteSymbol */}
          <Input
            type="number"
            min="0"
          ...
          />
          <div className="text-xs text-right text-[#8D8E99] mt-3.5">
            ≈ {baseSize || "--"}{`${marketConfig.baseSymbol.toLowerCase()}`}
          </div>
        </div>}
